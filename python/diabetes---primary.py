...
codes = [{"code":"66A3.00","system":"readv2"},{"code":"66AJ100","system":"readv2"},{"code":"250 A","system":"oxmis"},{"code":"250 AN","system":"oxmis"},{"code":"250 NT","system":"oxmis"},{"code":"250 PG","system":"oxmis"}];
REQUIRED_CODES = 1;
