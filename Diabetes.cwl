...
steps:
  ...
  diabetes-insulin---primary:
    run: diabetes-insulin---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-onset---primary:
    run: diabetes-onset---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-insulin---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-onset---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
